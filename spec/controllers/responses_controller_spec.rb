...
describe ResponsesController do
  ...
  let(:valid_attributes) { { "short_text" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved response as @response" do
        ...
        post :create, {:response => { "short_text" => "invalid value" }}, valid_session
        assigns(:response).should be_a_new(Response)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested response" do
        ...
        Response.any_instance.should_receive(:update_attributes).with({ "short_text" => "MyText" })
        put :update, {:id => response.to_param, :response => { "short_text" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the response as @response" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Response.any_instance.stub(:save).and_return(false)
        put :update, {:id => response.to_param, :response => { "short_text" => "invalid value" }}, valid_session
        assigns(:response).should eq(response)
      end
