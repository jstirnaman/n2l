  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interview as @interview" do
        ...
        post :create, {:interview => { "date" => "invalid value" }}, valid_session
        assigns(:interview).should be_a_new(Interview)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interview" do
        ...
        Interview.any_instance.should_receive(:update_attributes).with({ "date" => "2013-07-15" })
        put :update, {:id => interview.to_param, :interview => { "date" => "2013-07-15" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the interview as @interview" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interview.any_instance.stub(:save).and_return(false)
        put :update, {:id => interview.to_param, :interview => { "date" => "invalid value" }}, valid_session
        assigns(:interview).should eq(interview)
      end
